  ...
  return (
    <>
      ...
      <div className="bg-white h-full">
        <div className="container pt-10 pb-32 lg:pt-16 mx-auto lg:px-64">
          <Link
            href="/"
            className="text-3xl font-medium text-primary mt-8 flex justify-end"
          >
            <FaBackspace />
          </Link>
          ...
          {/* <img src={bannerImage} /> */}
          <article className="prose lg:prose-xl mt-10 text-justify text-primary mx-auto">
